...
void init_ship_sprites(void) {
    ...
    for(i = 0; i < 10; i++) {
        ...
        wing_sprites[i] = s = sp1_CreateSpr(SP1_DRAW_LOAD1LB, SP1_TYPE_1BYTE, 4, 0, 0);
        sp1_AddColSpr(s, SP1_DRAW_LOAD1, SP1_TYPE_1BYTE, column2_offset, 0);
        sp1_AddColSpr(s, SP1_DRAW_LOAD1, SP1_TYPE_1BYTE, column3_offset, 0);
        sp1_AddColSpr(s, SP1_DRAW_LOAD1RB, SP1_TYPE_1BYTE, 0, 0);
    }
}
